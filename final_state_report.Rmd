...
```{r plots5, fig.dim = c(6, 4), dpi=300, out.width = '100%', fig.cap="Figure 2-8. Comparison of Transportation Sector Fuel Use.", echo=FALSE, warning=FALSE, results=FALSE, message=FALSE}
