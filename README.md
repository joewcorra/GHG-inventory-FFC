...
Corra, J. 2025. GHG-inventory-FFC: A toolkit for retrieving, processing, and reporting fossil fuel combustion emissions data for the U.S. Greenhouse Gas Inventory, with support for both national and state-level analyses. GitHub repository: https://github.com/joewcorra/GHG-inventory-FFC
